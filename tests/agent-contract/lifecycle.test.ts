...
describe("lifecycle", () => {
  it("expected: stable promotion is a separate PR with replacement rules", () => {
    const governance = readFileSync(".agents/kit/host-policy/docs/GOVERNANCE.md", "utf8")
    const skill = readFileSync(".agents/kit/skill-templates/template-lifecycle/SKILL.md", "utf8")
